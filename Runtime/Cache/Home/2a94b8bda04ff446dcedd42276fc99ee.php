...
<body id="blog">
<!-- nav start -->
<?php $nav = array(); $nav[] = array("name"=>"首页","url"=>"./index.php"); $nav[] = array("name"=>"博客列表","url"=>"./index.php/List"); $nav[] = array("name"=>"个人日志","url"=>"./index.php/MyLog"); ?>
<nav class="am-g am-g-fixed blog-fixed blog-nav">
    <button class="am-topbar-btn am-topbar-toggle am-btn am-btn-sm am-btn-success am-show-sm-only blog-button" data-am-collapse="{target: '#blog-collapse'}" ><span class="am-sr-only">导航切换</span> <span class="am-icon-bars"></span></button>
    <div class="am-collapse am-topbar-collapse" id="blog-collapse">
        <ul class="am-nav am-nav-pills am-topbar-nav">
            <?php if(is_array($nav)): $k = 0; $__LIST__ = $nav;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($k % 2 );++$k; if($k == $pageindex): ?><li class="am-active"><a href="<?php echo ($item["url"]); ?>"><?php echo ($item["name"]); ?></a></li>
                    <?php else: ?>
                    <li><a href="<?php echo ($item["url"]); ?>"><?php echo ($item["name"]); ?></a></li><?php endif; endforeach; endif; else: echo "" ;endif; ?>
        </ul>
...
<div class="am-g am-g-fixed blog-fixed">
    ...
    <div class="am-u-md-8 am-u-sm-12">
        <?php if(is_array($data)): $k = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($k % 2 );++$k;?><article class="am-g blog-entry-article">
                    <div class="am-u-lg-6 am-u-md-12 am-u-sm-12 blog-entry-img">
                        <img src="<?php echo ($item["cover_img"]); ?>" alt="" class="am-u-sm-12">
                    </div>
                    <div class="am-u-lg-6 am-u-md-12 am-u-sm-12 blog-entry-text">
                        <span><a href="" class="blog-color"><?php echo ($item["author"]); ?> &nbsp;</a></span>
                        <span><?php echo ($item["add_time"]); ?></span>
                        <h1><a href="./index.php/Blog?id=<?php echo ($item["id"]); ?>"><?php echo ($item["title"]); ?></a></h1>
                        <p><?php echo ($item["introduction"]); ?></p>
                        <p><a href="" class="blog-continue">continue reading</a></p>
                    </div>
            </article><?php endforeach; endif; else: echo "" ;endif; ?>
        <p style="text-align: center"><a href="./index.php/list">查看更多</a></p>
    </div>

    <div class="am-u-md-4 am-u-sm-12 blog-sidebar">
        <div class="blog-sidebar-widget blog-bor">
            <h2 class="blog-text-center blog-title"><span>About ME</span></h2>
            <img src="/Application/Home/Static/i/f14.jpg" alt="about me" class="blog-entry-img" >
            <p>妹纸</p>
            <p>
