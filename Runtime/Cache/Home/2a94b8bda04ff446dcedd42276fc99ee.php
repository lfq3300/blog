                ...
                <main id="main" class="site-main" role="main">
                    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><article id="post-2250" class="post-2250 post type-post status-publish format-standard hentry category-learning-record">
                            <header class="entry-header">
                                ...
                                <h2 class="entry-title"><a href="/index.php/index/blog?id=<?php echo ($item["id"]); ?>" rel="bookmark"><?php echo ($item["title"]); ?></a></h2> </header>
                            <!-- .entry-header -->
                            ...
                            <footer class="entry-footer">
                                        ...
                                        <span class="cat-links">
                                            ...
                                            <a href="/?typeId=<?php echo ($item["assortment_id"]); ?>" rel="category tag"><?php echo ($item["assortment_name"]); ?></a>
                                        </span>
                            </footer>
                            <!-- .entry-footer -->
    ...
    <section id="search-3" class="widget widget_search">
        <form role="search" method="get" class="search-form" action="/">
            <label>
                ...
                <input type="search" class="search-field" placeholder="Search …" value="<?php echo ($_GET['key']); ?>" name="key">
            </label>
            <button type="submit" class="search-submit"><span class="screen-reader-text">Search</span></button>
        </form>
    </section>
    <section  class="widget widget_archive">
        <h2 class="widget-title"><a href="/index.php/Log">Log</a></h2>
    </section>
    <?php if(is_array($firsttnav)): $i = 0; $__LIST__ = $firsttnav;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$first): $mod = ($i % 2 );++$i;?><section id="archives-<?php echo ($first["id"]); ?>" class="widget widget_archive">
            <h2 class="widget-title"><?php echo ($first["assortment_name"]); ?></h2>
            <ul>
                <?php if(is_array($twotnav)): $i = 0; $__LIST__ = $twotnav;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$two): $mod = ($i % 2 );++$i; if($first['id'] == $two['p_id']): ?><li>
                            <a href="/?typeid=<?php echo ($two["id"]); ?>"><?php echo ($two["assortment_name"]); ?></a>&nbsp;(<?php echo ($two["blog_num"]); ?>)
    ...
    <!--<section id="tag_cloud-3" class="widget widget_tag_cloud">-->
        ...
        <!--<div class="tagcloud">-->
            <!--<ul class="wp-tag-cloud" role="list">-->
                <!--<li>-->
                    <!--<a href="JavaScript:void(0)" class="tag-cloud-link tag-link-79 tag-link-position-45" style="font-size: 1em;">验证码</a>-->
                <!--</li>-->
            <!--</ul>-->
        <!--</div>-->
    <!--</section>-->
